...
<div class="login-info">
	<span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
		...
		<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
			<img src="{{asset('assets/backend/img/avatars/sunny.png')}}" alt="me" class="online" /> 
			<span>
				{{Auth::user()->name}}
			</span>
...
<nav>
	<ul>
		...
		<li class="top-menu-invisible">
			<a href="#"><i class="fa fa-lg fa-fw fa-cube txt-color-blue"></i> <span class="menu-item-parent">Manage Categories</span></a>
			<ul>
				<li class="">
					<a href="{{route('category.create')}}" title="Dashboard"><i class="fa fa-lg fa-fw fa-gear"></i> <span class="menu-item-parent">Add New</span></a>
				</li>
				<li class="">
					<a href="{{route('category.index')}}" title="Dashboard"><i class="fa fa-lg fa-fw fa-picture-o"></i> <span class="menu-item-parent">List Categories</span></a>
				</li>
			</ul>
		</li>
		<li class="top-menu-invisible">
			<a href="#"><i class="fa fa-lg fa-fw fa-cube txt-color-blue"></i> <span class="menu-item-parent">Manage Tags</span></a>
			<ul>
				<li class="">
					<a href="{{route('tag.create')}}" title="Dashboard"><i class="fa fa-lg fa-fw fa-gear"></i> <span class="menu-item-parent">Add New</span></a>
				</li>
				<li class="">
					<a href="{{route('tag.index')}}" title="Dashboard"><i class="fa fa-lg fa-fw fa-picture-o"></i> <span class="menu-item-parent">List Tags</span></a>
				</li>
			</ul>
		</li>
		<li class="top-menu-invisible">
			<a href="#"><i class="fa fa-lg fa-fw fa-cube txt-color-blue"></i> <span class="menu-item-parent">Manage Posts</span></a>
			<ul>
				<li class="">
					<a href="{{route('post.create')}}" title="Dashboard"><i class="fa fa-lg fa-fw fa-gear"></i> <span class="menu-item-parent">Add New</span></a>
				</li>
				<li class="">
					<a href="{{route('post.index')}}" title="Dashboard"><i class="fa fa-lg fa-fw fa-picture-o"></i> <span class="menu-item-parent">List Posts</span></a>
				</li>
			</ul>
		</li>				
		<li>
			<a href="inbox.html"><i class="fa fa-lg fa-fw fa-inbox"></i>
				<span class="menu-item-parent">Outlook</span>
		...
		<li class="active">
			<a href="widgets.html"><i class="fa fa-lg fa-fw fa-list-alt"></i>
				<span class="menu-item-parent">Widgets</span></a>
		</li>
		<li>
